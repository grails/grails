class PluginViewsFunctionalTests extends functionaltestplugin.FunctionalTestCase {
    void testInPlacePluginView() {
        ...
        // Load the DB Util plugin's data view. This uses a plugin layout
        // too, so we get to kill two birds with one stone.
        get "/dbUtil/data" 
        assertStatus 200
        assertNotNull byXPath("//a[text() = 'Display Data']")
        assertNotNull byXPath("//a[text() = 'Database Info']")
