<cache:text id="downloadPanel">
    <div id="downloadLink">
        ...
        User Documentation: <a href="http://grails.org/doc/1.1/">Online</a> | <download:link software="Grails Documentation" version="${grailsDocs?.softwareVersion}" file="Binary Zip">Zip</download:link> <br />
